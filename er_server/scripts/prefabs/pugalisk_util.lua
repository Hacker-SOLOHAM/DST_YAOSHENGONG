...
--    print("FINDING TARGET FOR PUGALISK")
    -- local jogador =  GetClosestInstWithTag({"player","animal","monster"}, inst, 40)
	-- local jogador =  GetClosestInstWithTag("player", inst, 40)
	local jogador =  GetRandomInstWithTag("player", inst, 80)
	...
	-- jogador = jogador ==nil and GetClosestInstWithTag("monster", inst, 40)
	-- jogador = jogador ==nil and GetClosestInstWithTag("animal", inst, 40)
