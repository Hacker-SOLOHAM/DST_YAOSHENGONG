...
local function onattacked(inst, data)
	...
	if inst.sg:HasStateTag("hiding") and inst.sg:HasState("hide_hit") and not inst.sg:HasStateTag("nointerrupt") then
...
CommonForgeStates.AddIdle = function(states, funny_idle_state, anim_override, timeline)
    table.insert(states, State {
        ...
        onenter = function(inst, pushanim)
			if inst.sg.mem.wants_to_taunt and inst.sg:HasState("taunt") then
	...
	table.insert(states, State {
		...
		onenter = function(inst, data)
			...
			if data.stimuli and data.stimuli == "electric" then
				...
				inst.SoundEmitter:PlaySound(sounds and sounds.stun and inst.sounds[sounds.stun] or inst.sounds.stun or inst.sounds.hit)
			else
