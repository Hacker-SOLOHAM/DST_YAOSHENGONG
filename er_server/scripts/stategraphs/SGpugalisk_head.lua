...
local states=
{
    ...
    State{
        ...
        timeline=
        {
            -- TimeEvent(20*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/death") end),
			TimeEvent(20*FRAMES, function(inst) inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/death") end),
        },
    ...
    State{
        ...
        timeline=
        {
            -- TimeEvent(2*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/hit") end),
			TimeEvent(2*FRAMES, function(inst) inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/hit") end),
        },
    ...
    State{
        ...
        timeline=
        {
            -- TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/taunt") end),
			TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/taunt") end),
        },
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(1*FRAMES, function(inst) 
                    ...
                    -- inst.SoundEmitter:PlaySound("Hamlet/common/volcano/volcano_erupt")		
					inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/volcano_erupt")
                end),
            -- TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/taunt") end),
            -- TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/attack") end),
			TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/taunt") end),
            -- TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/attack") end),
			TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/SnakeStart") end),
        },
    ...
    State{
        ...
        events=
        {
            EventHandler("animover", function(inst)              
                ...
                -- inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/gaze_start") 
				inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/gaze_start")
            end),
        },    
    },
    ...
    State{
        ...
        onenter = function(inst, start_anim)   
            ...
            -- inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/gaze_LP","gazor")
			inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/gaze_LP","gazor")
        end,
    ...
    State{
        ...
        timeline =
        {
            ...
            -- TimeEvent(3*FRAMES, function(inst)  if not inst:HasTag("tail") then inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/attack") end end),
            -- TimeEvent(6*FRAMES, function(inst)  if not inst:HasTag("tail") then inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/attack_pre") end end),
            -- TimeEvent(18*FRAMES, function(inst)  if not inst:HasTag("tail") then inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/bite") end end),
            -- TimeEvent(7*FRAMES, function(inst)  if inst:HasTag("tail") then inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/tail_attack") end end),
			TimeEvent(3*FRAMES, function(inst)  if not inst:HasTag("tail") then inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/attack") end end),
            -- TimeEvent(6*FRAMES, function(inst)  if not inst:HasTag("tail") then inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/attack") end end),
            TimeEvent(18*FRAMES, function(inst)  if not inst:HasTag("tail") then inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/bite") end end),
            TimeEvent(7*FRAMES, function(inst)  if inst:HasTag("tail") then inst.SoundEmitter:PlaySound("LF_Snake/pugalisk/tail_attack") end end),
        },
